...
def generate(dataset_name, base_par_dir, copy_image=True, is_downsample=False, downsample_scale=1, fixed_camera=True, wrong_camera=[]):
    ...
    output_dir = base_dir #f'./{dataset_name}'
    print(output_dir)
    print(base_dir)
    ...
    if copy_image:
        new_image_dir = join(output_dir, "image_neus2")
...
if __name__ == "__main__":
    #base_par_dir = "D:/MV_data/DTU/data/"
    base_par_dir = "D:/MV_data/manikins/data/"
    import argparse
