        ...
        for iter_step in tqdm(range(self.end_iter)):
            ...
            if self.double_net:
                if self.position_encoding:
                    ...
                    self.norm_features_grad[:nb_samples,:] = rgb_feat.grad[:,shift_p+5:shift_p+8] #math.sin(0.5*math.pi*self.loc_iter/self.end_iter_loc)*rgb_feat.grad[:,shift_p+5:shift_p+8] +\
            ...
            if (iter_step+1) == 2000 or (iter_step+1) == 10000 or (iter_step+1) == 30000 or (iter_step+1) == 50000 or (iter_step+1) == 70000:# or (iter_step+1) == 45000:
                ...
                if (iter_step+1) == 70000:
                    ...
                    self.tv_w = 1.0e-4 #1.0e-4 #1.0e-3
